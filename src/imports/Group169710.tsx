import svgPaths from "./svg-663my8kaqs";
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Label  + Title">
      <div className="content-stretch flex flex-col gap-[4px] items-start pr-[76px] relative w-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] not-italic relative shrink-0 text-[21px] text-white w-full">Edit Entity Tag</p>
      </div>
    </div>
  );
}
...
function LabelTitle1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Label  + Title">
      <div className="content-stretch flex flex-col gap-[4px] items-start pr-[76px] relative w-full">
        <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#161616] text-[20px] w-full">Edit Entity Tag</p>
      </div>
    </div>
  );
}
...
function Spacer() {
  return <div className="bg-[rgba(255,255,255,0)] flex-[1_0_0] h-[64px] min-h-px min-w-px mix-blend-multiply z-[6]" data-name="Spacer" />;
}

function LoadingStatus() {
  return (
    <div className="content-stretch flex items-center pt-px relative shrink-0" data-name="Loading status">
      <div className="content-stretch flex items-start relative shrink-0" data-name="Loading/Small/Active">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <div className="content-stretch flex items-start relative shrink-0" data-name="_Loading animation">
          <div className="relative shrink-0 size-[16px]" data-name="_Loading base">
            <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
              <path d={svgPaths.p1e012700} id="Ellipse" stroke="var(--stroke-0, #C6C6C6)" strokeWidth="3" />
            </svg>
            <div className="absolute bottom-1/2 left-0 right-[9.55%] top-0">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.4721 8">
                <path d={svgPaths.p29d88b80} id="Ellipse" stroke="var(--stroke-0, #2A53A0)" strokeWidth="3" />
              </svg>
            </div>
          </div>
        </div>
...
function InlineLoading() {
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative z-[2]" data-name="Inline loading">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center p-[16px] relative size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0 w-[145.75px]" data-name="Inline loading">
            <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
            <LoadingStatus />
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#525252] text-[16px] tracking-[0.16px] whitespace-nowrap">Please wait it’s Loading</p>
          </div>
        </div>
      </div>
    </div>
...
function Group1() {
  return (
    <div className="absolute contents inset-[72%_51.83%_20.33%_4.27%]">
      ...
      <UitCalender />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[74.04%_73.68%_22.3%_6.95%] leading-[1.4] not-italic text-[#161616] text-[16px]">20-02-2026</p>
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents inset-[72%_5.49%_20.33%_50.61%]">
      ...
      <UitCalender1 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[74%_27.4%_22.33%_53.69%] leading-[1.4] not-italic text-[#161616] text-[16px]">20-02-2027</p>
    </div>
  );
}
...
function FromToDate() {
  return (
    <div className="absolute contents inset-[66.17%_5.49%_20.33%_4.27%]" data-name="From & To Date">
      <Group2 />
    </div>
  );
}
  ...
  return (
    <div className="relative size-full">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white content-stretch flex flex-col h-[600px] items-start left-1/2 pb-[65px] pt-px px-px rounded-[8px] top-1/2 w-[820px]" data-name="Modal">
        ...
        <Header />
        <HeaderSpacer />
        <div className="absolute bottom-0 h-[64px] left-0 right-0" data-name="Actions">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-px isolate items-start relative size-full">
            <div className="absolute inset-0 z-[8]" data-name="Border">
              <div aria-hidden="true" className="absolute border-[#c6c6c6] border-b border-l border-r border-solid inset-0 pointer-events-none" />
            </div>
            <Spacer />
            <InlineLoading />
            <div className="absolute bg-[#f4f4f4] inset-0 rounded-bl-[8px] z-[1]" data-name="Background" />
          </div>
        </div>
        <Content />
      ...
      <div className="absolute bg-[#d9d9d9] h-[64px] left-[405px] top-[536px] w-[2px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-[179px] not-italic text-[#2a53a0] text-[16px] top-[559px] tracking-[0.16px] whitespace-nowrap">Cancel</p>
      <FromToDate />
