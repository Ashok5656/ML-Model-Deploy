import svgPaths from "./svg-p9tdf6aykf";
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_8002_5547)" id="Icon">
  ...
  return (
    <div className="absolute inset-[6.28%_0_67.52%_0.05%]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1615.11 178.414">
        <g id="Group 169601">
          <g id="Path 84378">
            <mask fill="white" id="path-1-inside-1_8002_5474">
              <path d="M0 0H1615.11V0.972471H0V0Z" />
            </mask>
            <path d="M0 0H1615.11V0.972471H0V0Z" fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p1491b780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-1-inside-1_8002_5474)" />
          </g>
          <g id="Group 169600">
            <g id="Path 84380">
              <mask fill="white" id="path-3-inside-2_8002_5474">
                <path d={svgPaths.p26c6b700} />
              </mask>
              <path d={svgPaths.p26c6b700} fill="var(--fill-0, #E0E0E0)" />
              <path d={svgPaths.p3a7dd100} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-3-inside-2_8002_5474)" />
            </g>
            <g id="Path 84379">
              <mask fill="white" id="path-5-inside-3_8002_5474">
                <path d={svgPaths.p268b5100} />
              </mask>
              <path d={svgPaths.p268b5100} fill="var(--fill-0, #E0E0E0)" />
              <path d={svgPaths.p2cadb740} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-5-inside-3_8002_5474)" />
            </g>
            <g id="Rectangle 17516">
              <mask fill="white" id="path-7-inside-4_8002_5474">
                <path d={svgPaths.p21364a00} />
              </mask>
              <path d={svgPaths.p21364a00} fill="var(--fill-0, #E0E0E0)" />
              <path d={svgPaths.p908e780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-7-inside-4_8002_5474)" />
            </g>
            <g id="Rectangle 17517">
              <mask fill="white" id="path-9-inside-5_8002_5474">
                <path d={svgPaths.p3ab6ae00} />
              </mask>
              <path d={svgPaths.p3ab6ae00} fill="var(--fill-0, #E0E0E0)" />
              <path d={svgPaths.p25732f80} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-9-inside-5_8002_5474)" />
            </g>
          </g>
        </g>
      </svg>
  ...
  return (
    <div className="absolute inset-[39.23%_0_47.6%_0.05%]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1615.11 89.693">
        <g id="Group 169602">
          <g id="Path 84381">
            <mask fill="white" id="path-1-inside-1_8002_5508">
              <path d={svgPaths.p13b07a00} />
            </mask>
            <path d={svgPaths.p13b07a00} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p908e780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-1-inside-1_8002_5508)" />
          </g>
          <g id="Rectangle 17518">
            <mask fill="white" id="path-3-inside-2_8002_5508">
              <path d={svgPaths.p1964ee80} />
            </mask>
            <path d={svgPaths.p1964ee80} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p1491b780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-3-inside-2_8002_5508)" />
          </g>
          <g id="Rectangle 17519">
            <mask fill="white" id="path-5-inside-3_8002_5508">
              <path d={svgPaths.p10c7b000} />
            </mask>
            <path d={svgPaths.p10c7b000} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p3a7dd100} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-5-inside-3_8002_5508)" />
          </g>
        </g>
      </svg>
    </div>
  ...
  return (
    <div className="absolute inset-[59.16%_0_1.62%_0.05%]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1615.11 267.134">
        <g id="Group 169603">
          <g id="Path 84382">
            <mask fill="white" id="path-1-inside-1_8002_5444">
              <path d="M0 0H1615.11V0.972471H0V0Z" />
            </mask>
            <path d="M0 0H1615.11V0.972471H0V0Z" fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p1491b780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-1-inside-1_8002_5444)" />
          </g>
          <g id="Path 84383">
            <mask fill="white" id="path-3-inside-2_8002_5444">
              <path d={svgPaths.p262a4200} />
            </mask>
            <path d={svgPaths.p262a4200} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p102dd7f0} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-3-inside-2_8002_5444)" />
          </g>
          <g id="Rectangle 17520">
            <mask fill="white" id="path-5-inside-3_8002_5444">
              <path d={svgPaths.p10c7b000} />
            </mask>
            <path d={svgPaths.p10c7b000} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p3a7dd100} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-5-inside-3_8002_5444)" />
          </g>
          <g id="Rectangle 17521">
            <mask fill="white" id="path-7-inside-4_8002_5444">
              <path d={svgPaths.p9a77c00} />
            </mask>
            <path d={svgPaths.p9a77c00} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p12711000} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-7-inside-4_8002_5444)" />
          </g>
          <g id="Rectangle 17524">
            <mask fill="white" id="path-9-inside-5_8002_5444">
              <path d={svgPaths.p16fcaf00} />
            </mask>
            <path d={svgPaths.p16fcaf00} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p3bc24c00} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-9-inside-5_8002_5444)" />
          </g>
          <g id="Rectangle 17522">
            <mask fill="white" id="path-11-inside-6_8002_5444">
              <path d={svgPaths.p21364a00} />
            </mask>
            <path d={svgPaths.p21364a00} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p908e780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-11-inside-6_8002_5444)" />
          </g>
          <g id="Rectangle 17523">
            <mask fill="white" id="path-13-inside-7_8002_5444">
              <path d={svgPaths.p1c9e8380} />
            </mask>
            <path d={svgPaths.p1c9e8380} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p1a22c200} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-13-inside-7_8002_5444)" />
          </g>
        </g>
      </svg>
    </div>
...
function Component() {
  return (
    <div className="bg-[#2a53a0] flex-[1_0_0] min-h-px min-w-px relative rounded-br-[8px] self-stretch z-[2]" data-name="1">
...
function UitCalender() {
  return (
    <div className="absolute aspect-[24/24] left-[47.02%] overflow-clip right-[51.78%] top-[683.45px]" data-name="uit:calender">
...
function Group28() {
  return (
    <div className="absolute contents inset-[62.22%_50.78%_33.52%_30.47%]">
      <div className="absolute bg-white border border-[#bdbdbd] border-solid inset-[62.22%_50.78%_33.52%_30.47%] rounded-[8px]" />
      <UitCalender />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[63.35%_60.12%_34.61%_31.62%] leading-[1.4] not-italic text-[#161616] text-[16px]">20-02-2026</p>
    </div>
  );
}
...
function Group31() {
  return (
    <div className="absolute contents left-[30.47%] right-[50.78%] top-[637px]">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[58.98%_64.13%_38.67%_30.47%] leading-[1.4] not-italic text-[#333] text-[16px]">From Date</p>
      <Group28 />
    </div>
  );
}
...
function UitCalender1() {
  return (
    <div className="absolute aspect-[24/24] left-[66.38%] overflow-clip right-[32.33%] top-[682.33px]" data-name="uit:calender">
      <div className="absolute inset-[8.33%]" data-name="Vector">
...
function Group27() {
  return (
    <div className="absolute contents inset-[62.22%_30.99%_33.52%_50.26%]">
      <div className="absolute bg-white border border-[#bdbdbd] border-solid inset-[62.22%_30.99%_33.52%_50.26%] rounded-[8px]" />
      <UitCalender1 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[63.33%_40.35%_34.63%_51.58%] leading-[1.4] not-italic text-[#161616] text-[16px]">20-02-2027</p>
    </div>
  );
}
...
function Group32() {
  return (
    <div className="absolute contents left-[50.26%] right-[30.99%] top-[637px]">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[58.98%_44.34%_38.67%_50.26%] leading-[1.4] not-italic text-[#333] text-[16px]">To Date</p>
      <Group27 />
    </div>
  );
}
...
function Group29() {
  return (
    <div className="absolute contents inset-[58.98%_30.99%_33.52%_30.47%]">
      <Group31 />
      <Group32 />
    </div>
  );
...
function FromToDate() {
  return (
    <div className="absolute contents inset-[58.98%_30.99%_33.52%_30.47%]" data-name="From & To Date">
      <Group29 />
    </div>
  );
}
...
function TextOverflow() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[18px] items-start min-h-px min-w-px overflow-clip relative z-[2]" data-name="Text overflow">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal h-[18px] leading-[18px] min-h-px min-w-px not-italic overflow-hidden relative text-[#161616] text-[16px] text-ellipsis text-left tracking-[0.16px] whitespace-nowrap">Whitelist</p>
    </div>
  );
}
...
function TextOverflow1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[18px] items-start min-h-px min-w-px overflow-clip relative z-[2]" data-name="Text overflow">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal h-[18px] leading-[18px] min-h-px min-w-px not-italic overflow-hidden relative text-[#161616] text-[16px] text-ellipsis text-left tracking-[0.16px] whitespace-nowrap">AACOUNT</p>
    </div>
  );
}
...
function Group30() {
  return (
    <div className="absolute contents left-[30.42%] right-[30.99%] top-[328px]">
      <div className="-translate-y-1/2 absolute content-stretch flex items-center justify-center left-[30.47%] px-[16px] py-[12px] right-[30.99%] rounded-[8px] top-[calc(50%-154px)]" data-name="Input Field">
        <div aria-hidden="true" className="absolute border border-[#bdbdbd] border-solid inset-0 pointer-events-none rounded-[8px]" />
        <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.4] min-h-px min-w-px not-italic relative text-[#333] text-[16px]">0100001234514</p>
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[30.37%_64.18%_67.28%_30.42%] leading-[1.4] not-italic text-[#333] text-[16px]">Entity ID</p>
    </div>
  );
}
...
function EntityId() {
  return (
    <div className="absolute contents inset-[30.37%_30.99%_62.13%_30.42%]" data-name="Entity ID">
      <Group30 />
    </div>
  );
}

function StashPlayLight() {
  return (
    <div className="absolute left-[1195px] size-[22px] top-[798px]" data-name="stash:play-light">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="stash:play-light">
          <path d={svgPaths.p3ed9a480} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function AddEntityTagValues() {
  return (
    <div className="bg-white relative size-full" data-name="Add Entity Tag - Values">
      ...
      <Group33 />
      <Container29 />
      <div className="absolute h-[778px] left-[280.89px] top-[237px] w-[1618.225px]" data-name="Component 1">
        <Group22 />
        <Frame1 />
        <Group41 />
      </div>
      ...
      <div className="absolute h-[1080px] right-0 top-0 w-[1920px]" data-name="Vector">
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-[726px] not-italic text-[#2a53a0] text-[16px] top-[799px] tracking-[0.16px] whitespace-nowrap">Cancel</p>
      <FromToDate />
      <button className="absolute content-stretch cursor-pointer flex flex-col items-start left-[574px] p-[10px] top-[522px] w-[760px]" data-name="Entity Tag">
      ...
      <button className="absolute content-stretch cursor-pointer flex flex-col items-start left-[574px] p-[10px] top-[424px] w-[761px]" data-name="Entity Type">
        <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-name="Dropdown - Default">
          <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
          <LabelMargin1 />
          <DropdownInput1 />
