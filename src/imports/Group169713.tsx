import svgPaths from "./svg-r28s6i3fn7";
    ...
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative z-[2]" data-name="Inline loading">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center p-[16px] relative size-full">
          <div className="content-stretch flex gap-[8px] items-start relative shrink-0" data-name="Inline loading">
            <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
            <LoadingStatus />
...
function Group22() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <p className="col-1 font-['Inter:Regular',sans-serif] font-normal h-[12.809px] leading-[normal] ml-[26px] mt-[13.48px] not-italic relative row-1 text-[#525252] text-[16px] w-[170px]">Approved By Ashok</p>
    </div>
  );
}
  ...
  return (
    <div className="relative size-full">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white content-stretch flex flex-col h-[500px] items-start left-1/2 pb-[65px] pt-px px-px rounded-[8px] top-1/2 w-[820px]" data-name="Modal">
        ...
        <Header />
        <HeaderSpacer />
        <div className="absolute bottom-0 h-[64px] left-0 right-0 rounded-bl-[8px] rounded-br-[8px]" data-name="Actions">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex isolate items-start relative size-full">
            <div className="absolute inset-0 rounded-bl-[8px] rounded-br-[8px] z-[8]" data-name="Border">
      ...
      <div className="absolute bg-[#d9d9d9] h-[64px] left-[405px] top-[436px] w-[2px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-[189px] not-italic text-[#2a53a0] text-[16px] top-[460px] tracking-[0.16px] whitespace-nowrap">Cancel</p>
      <Group21 />
      <Group19 />
      <Frame1 />
    </div>
