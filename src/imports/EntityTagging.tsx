import svgPaths from "./svg-pek60rtrok";
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_8002_5063)" id="Icon">
...
function Button19() {
  return (
    <div className="absolute border border-[rgba(0,0,0,0)] border-solid h-[36px] left-[305px] rounded-[8px] top-0 w-[157.406px]" data-name="Button">
      <Container25 />
      <div className="absolute flex items-center justify-center left-[139.41px] size-[16px] top-[9px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "154" } as React.CSSProperties}>
  ...
  return (
    <div className="absolute inset-[6.28%_0_67.52%_0.05%]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1615.11 178.414">
        <g id="Group 169601">
          <g id="Path 84378">
            <mask fill="white" id="path-1-inside-1_8002_5005">
              <path d="M0 0H1615.11V0.972471H0V0Z" />
            </mask>
            <path d="M0 0H1615.11V0.972471H0V0Z" fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p1491b780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-1-inside-1_8002_5005)" />
          </g>
          <g id="Group 169600">
            <g id="Path 84380">
              <mask fill="white" id="path-3-inside-2_8002_5005">
                <path d={svgPaths.p26c6b700} />
              </mask>
              <path d={svgPaths.p26c6b700} fill="var(--fill-0, #E0E0E0)" />
              <path d={svgPaths.p3a7dd100} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-3-inside-2_8002_5005)" />
            </g>
            <g id="Path 84379">
              <mask fill="white" id="path-5-inside-3_8002_5005">
                <path d={svgPaths.p268b5100} />
              </mask>
              <path d={svgPaths.p268b5100} fill="var(--fill-0, #E0E0E0)" />
              <path d={svgPaths.p2cadb740} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-5-inside-3_8002_5005)" />
            </g>
            <g id="Rectangle 17516">
              <mask fill="white" id="path-7-inside-4_8002_5005">
                <path d={svgPaths.p21364a00} />
              </mask>
              <path d={svgPaths.p21364a00} fill="var(--fill-0, #E0E0E0)" />
              <path d={svgPaths.p908e780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-7-inside-4_8002_5005)" />
            </g>
            <g id="Rectangle 17517">
              <mask fill="white" id="path-9-inside-5_8002_5005">
                <path d={svgPaths.p3ab6ae00} />
              </mask>
              <path d={svgPaths.p3ab6ae00} fill="var(--fill-0, #E0E0E0)" />
              <path d={svgPaths.p25732f80} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-9-inside-5_8002_5005)" />
            </g>
          </g>
        </g>
      </svg>
  ...
  return (
    <div className="absolute inset-[39.23%_0_47.6%_0.05%]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1615.11 89.693">
        <g id="Group 169602">
          <g id="Path 84381">
            <mask fill="white" id="path-1-inside-1_8002_5050">
              <path d={svgPaths.p13b07a00} />
            </mask>
            <path d={svgPaths.p13b07a00} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p908e780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-1-inside-1_8002_5050)" />
          </g>
          <g id="Rectangle 17518">
            <mask fill="white" id="path-3-inside-2_8002_5050">
              <path d={svgPaths.p1964ee80} />
            </mask>
            <path d={svgPaths.p1964ee80} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p1491b780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-3-inside-2_8002_5050)" />
          </g>
          <g id="Rectangle 17519">
            <mask fill="white" id="path-5-inside-3_8002_5050">
              <path d={svgPaths.p10c7b000} />
            </mask>
            <path d={svgPaths.p10c7b000} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p3a7dd100} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-5-inside-3_8002_5050)" />
          </g>
        </g>
      </svg>
    </div>
  ...
  return (
    <div className="absolute inset-[59.16%_0_1.62%_0.05%]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1615.11 267.134">
        <g id="Group 169603">
          <g id="Path 84382">
            <mask fill="white" id="path-1-inside-1_8002_4985">
              <path d="M0 0H1615.11V0.972471H0V0Z" />
            </mask>
            <path d="M0 0H1615.11V0.972471H0V0Z" fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p1491b780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-1-inside-1_8002_4985)" />
          </g>
          <g id="Path 84383">
            <mask fill="white" id="path-3-inside-2_8002_4985">
              <path d={svgPaths.p262a4200} />
            </mask>
            <path d={svgPaths.p262a4200} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p102dd7f0} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-3-inside-2_8002_4985)" />
          </g>
          <g id="Rectangle 17520">
            <mask fill="white" id="path-5-inside-3_8002_4985">
              <path d={svgPaths.p10c7b000} />
            </mask>
            <path d={svgPaths.p10c7b000} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p3a7dd100} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-5-inside-3_8002_4985)" />
          </g>
          <g id="Rectangle 17521">
            <mask fill="white" id="path-7-inside-4_8002_4985">
              <path d={svgPaths.p9a77c00} />
            </mask>
            <path d={svgPaths.p9a77c00} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p12711000} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-7-inside-4_8002_4985)" />
          </g>
          <g id="Rectangle 17524">
            <mask fill="white" id="path-9-inside-5_8002_4985">
              <path d={svgPaths.p16fcaf00} />
            </mask>
            <path d={svgPaths.p16fcaf00} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p3bc24c00} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-9-inside-5_8002_4985)" />
          </g>
          <g id="Rectangle 17522">
            <mask fill="white" id="path-11-inside-6_8002_4985">
              <path d={svgPaths.p21364a00} />
            </mask>
            <path d={svgPaths.p21364a00} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p908e780} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-11-inside-6_8002_4985)" />
          </g>
          <g id="Rectangle 17523">
            <mask fill="white" id="path-13-inside-7_8002_4985">
              <path d={svgPaths.p1c9e8380} />
            </mask>
            <path d={svgPaths.p1c9e8380} fill="var(--fill-0, #E0E0E0)" />
            <path d={svgPaths.p1a22c200} fill="var(--stroke-0, #E0E0E0)" mask="url(#path-13-inside-7_8002_4985)" />
          </g>
        </g>
      </svg>
    </div>
